...
//  { "genomeSize", 'g', "K/M/G/T",0,"Genome size scale ( with K/M/G). K for single or few genes, M for prokayote genome, G for mammals genome. If specified, will be used for determing context length.[M]\v", 1},
  {"halfKmerLen",'k', "INT",  0, "Half k-mer length. Suggested: 8 for prokaryotes, 10 or 11 for mammals. [8]\v" },
	{"halfSubstrLen",'s',"INT", 0,"Half substring length. [5]\v" },
	{"level",'l',"INT", 0, "Dimensionality-reduction level. Expected reduction rate is 16^n for -l n. [2]\v",7},
	{"outfile",'o',"STRING",0,"Output file prefix. If omitted, writes default.shuf.\v"},
//	{0,0,0,0,"reserved option for aa:\v",-1},
	{"usedefault",999,0,0,"Use default prokaryote settings: k=8, s=5, l=2.\v",8}, 
  { 0 }
};

static char doc_shuffle[] =
  "\n"
  "Generate dimensionality-reduction shuffle files."
  "\v"
  "Examples:\n"
  "  kssd3a shuffle --usedefault -o default\n"
  "  kssd3a shuffle -k 10 -s 6 -l 2 -o mammal_L2\n"
  ;
